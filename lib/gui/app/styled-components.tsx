...
export interface GenericTableProps<T extends {}> extends BaseTableProps<T> {
...
function StyledTable<T extends {}>() {
	return styled((_props: GenericTableProps<T>) => (
		<GenericTable<T> {..._props} />
	))`
