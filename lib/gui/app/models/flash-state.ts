...
/** Returns elapsed flash time in seconds, or null if timing data is unavailable. */
export function getFlashDurationSeconds(): number | null {
	if (flashStartTime === null || flashEndTime === null) {
		return null;
	}
	return Math.round((flashEndTime - flashStartTime) / 1000);
}
